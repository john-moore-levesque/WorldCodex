  ...
  return (
    <div style={S.overlay}><div style={S.modal}>
      ...
      <div style={S.modalBody}>
        ...
        <div style={S.fieldRow}><label style={S.label}>Principles</label><textarea value={form.principles} onChange={e=>set("principles",e.target.value)} style={{ ...S.input,minHeight:60,resize:"vertical",fontFamily:"inherit" }} /><div style={S.mdHint}>Markdown: **bold** *italic* - list ## heading</div></div>
        <div style={S.fieldRow}><label style={S.label}>Limitations</label><textarea value={form.limitations} onChange={e=>set("limitations",e.target.value)} style={{ ...S.input,minHeight:60,resize:"vertical",fontFamily:"inherit" }} /><div style={S.mdHint}>Markdown: **bold** *italic* - list ## heading</div></div>
